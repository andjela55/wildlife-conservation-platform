...
import { Collar, CollarAssignment, CreateCollarAssignmentRequest, CreateCollarRequest, UnassignCollarRequest, UpdateCollarRequest } from '../models/wildlife.models';
...
export class CollarApiService extends BaseApiService<Collar, CreateCollarRequest, UpdateCollarRequest> {
  ...
  getActiveAssignments(): Observable<CollarAssignment[]> {
    return this.http.get<CollarAssignment[]>(`${this.assignmentsUrl}/active`);
  }
